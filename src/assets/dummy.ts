...
const productItems: Array<productItem> = [
  {
    ...
    title:
      "포근한 니트로 만드는 나만의 글씨, 봉봉메이드 니트레터링 클래스 포근한 니트로 만드는 나만의 글씨, 봉봉메이드 니트레터링 클래스 포근한 니트로 만드는 나만의 글씨, 봉봉메이드 니트레터링 클래스",
    coverImage:
  ...
  },
  {
    ...
    title:
      "글씨가 주는 소소한 행복, Lettering Together! 글씨가 주는 소소한 행복, Lettering Together!",
    coverImage:
  ...
  },
  {
    ...
    title:
      "글씨 쓰는 김이영과 함께 아이패드에 그려낸 캘리그라피 글씨 쓰는 김이영과 함께 아이패드에 그려낸 캘리그라피 글씨 쓰는 김이영과 함께 아이패드에 그려낸 캘리그라피 글씨 쓰는 김이영과 함께 아이패드에 그려낸 캘리그라피",
    coverImage:
  ...
  },
  {
    ...
    title:
      "평범한 일상에 색을 더하는 시간, 자토의 아이패드 드로잉 평범한 일상에 색을 더하는 시간, 자토의 아이패드 드로잉 평범한 일상에 색을 더하는 시간, 자토의 아이패드 드로잉 평범한 일상에 색을 더하는 시간, 자토의 아이패드 드로잉",
    coverImage:
